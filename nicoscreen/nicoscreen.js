...
r9.NicoScreen = {
	...
	draw: function(str){
		...
		if(str){
			...
			username_str = n.comments[i].user;
			comment_str = n.comments[i].comment;
			n.draw_index++;
		}
		...
		var cmid = "cm" + i + "";
		var com_obj = $("<div id='" + cmid + "' style='left:" + n.env.width + "px; position:absolute;top:" + n.top_pos + "px;color:"+n.env.color+";font-size:"+n.env.font_size+";font-weight:bold;text-shadow: black 1px 1px 1px;width:100%;z-index:99999;cursor:default'>" + username_str + " : <span style='color:#2E9AFE'>" + comment_str + "</span></div>");
